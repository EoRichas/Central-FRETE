      ...
      <div className={styles.loader} aria-hidden="true">
        <div className={styles.truckWrapper}>
          ...
          <div className={styles.truckTires}>
            {[0, 1].map((wheel) => (
              <svg key={wheel} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className={styles.tiresvg}>
          ...
          <svg viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" fill="#000000" className={styles.lampPost}>
