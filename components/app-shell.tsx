      ...
      <aside className={`sidebar ${mobileOpen ? "mobile-open" : ""}`}>
        ...
        <div className="sidebar-user">
          <div className="sidebar-user-identity">
            <span className="avatar">{user?.name?.slice(0, 2) ?? "CE"}</span>
          ...
          <span className="sidebar-user-copy"><strong>{user?.name ?? "Carregando…"}</strong><small>{user ? roleLabel(user.role) : ""}</small></span>
