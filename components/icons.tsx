...
export const Icons = {
  ...
  calculator: (props: IconProps) => <IconBase {...props}><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M8 6h8v4H8zM8 14h1M12 14h1M16 14h1M8 18h1M12 18h1M16 18h1"/></IconBase>,
  tag: (props: IconProps) => <IconBase {...props}><path d="M20 13 13 20 4 11V4h7z"/><circle cx="8.5" cy="8.5" r="1.5"/></IconBase>,
